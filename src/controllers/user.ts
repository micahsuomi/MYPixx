...
import { nameValidator, emailValidator, passwordValidator } from '../validators/regex'
            ...
            .exec((err, foundGallery) => {
              if (err) {
                ...
                for (const gallery of foundGallery) {
                  gallery.author.name = user?.name as any
                  gallery.author.avatar = user?.avatar as any
                  gallery.author.bio = user?.bio as any
                  ...
                  .exec((err, foundComments) => {
                    if (err) {
                      ...
                      for (const comment of foundComments) {
                        comment.author.name = user?.name as any
                        comment.author.avatar = user?.avatar as any
